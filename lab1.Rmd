...
You can sign up for a student version of Domo [here](http://www.domo.com/start/student). You will have access to a current version of Domo for one year. Please be responsible regarding what data you upload to Domo.
...
* Domo
    ...
    * Go to the following Google Form and fill in the fields: [https://forms.gle/dY2kph4bg9meAXNn8](https://forms.gle/dY2kph4bg9meAXNn8)
        * To get the Access Token, do the following.
            * Click the waffle menu in the top right (to the left of your profile image).
            * Click Admin
            * Click Security
            * In the top right of the screen, click "Generate access token"
            * Description = Instructor creds, User = your user account, Expire after = 90 days
            * Paste the access token into the Google Form above
        * To get the developer tokens, do the following.
            * While you're logged in to Domo, go to [https://developer.domo.com](https://developer.domo.com)
...
* R Studio Cloud
    * Go to the following link: [link much too long](https://rstudio.cloud/spaces/20344/join?access_code=2HCnR%2B%2BP8WRCAJOTqOqRrGGEYh4FUi0oWGhIt%2FNb)
...
* To get credit for the assignment, copy the URL from your Overview page in Domo and submit it as proof you have completed all steps.
